...
public class ImageCut {
	...
	public static void abscut(String srcImageFile, String dirImageFile, int x,
		...
		abscut(new File(srcImageFile), new File(dirImageFile), x, y, destWidth,
				destHeight);
	}

	public static void abscut(File srcImageFile, File dirImageFile, int x,
			int y, int destWidth, int destHeight) {
		try {
			Image img;
	...
	public static void scale(String srcImageFile, String result, int _width,
			int _height) {
		scale(new File(srcImageFile), new File(result), _width, _height, 0, 0);
	}
	 ...
	 *            设置新的图像高度
	 */
	public static void scale(File srcImageFile, File result, int _width,
	...
	public static void main(String[] args) {
		...
		abscut("d:/2.jpg", "d:/3.jpg", 120, 33, 272, 379);
	}
}